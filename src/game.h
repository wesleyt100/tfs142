...
class Game
{
	public:
		...
		Item *findItemOfAttribute(Cylinder *cylinder, int64_t key, const std::string value) const;
		Item *findItemOfAttribute(Cylinder *cylinder, const std::string key, const std::string value) const;					 
		...
		void internalCreatureChangePersonalStore(Creature *creature, const PersonalStore &ps);
