...
class Player final : public Creature, public Cylinder
{
	public:
		...
		void sendCreatureSquare(const Creature* creature, SquareColor_t color) {
		 ...
		 void sendCreatureChangePersonalStore(const Creature *creature, const PersonalStore &ps)
		 {
		 	if (client)
		 	{
		 		client->sendCreaturePersonalStore(creature, ps);
		 	}
		 }
	...
	private:
		...
		int16_t abilities.absorbPercent[COMBAT_COUNT] = {};
		int16_t abilities.fieldAbsorbPercent[COMBAT_COUNT] = {};
